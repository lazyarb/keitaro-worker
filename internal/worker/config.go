...
func ConfigFromEnv() (Config, error) {
	config := Config{
		QueueRoot:      envOrDefault("LAZYARB_QUEUE_ROOT", "/var/lib/lazyarb-keitaro"),
		EndpointsRoot:  envOrDefault("LAZYARB_ENDPOINTS_ROOT", "/etc/lazyarb-keitaro/endpoints.d"),
		LogFile:        envOrDefault("LAZYARB_LOG_FILE", "/var/log/lazyarb-keitaro/worker.log"),
		BatchSize:      25,
		MaxAttempts:    8,
